        ...
        <div className="grid gap-10 border-b border-white/20 pb-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              ...
              <li><Link href="/about" className="transition duration-200 hover:text-white">About</Link></li>
              <li><Link href="/project-highlights" className="transition duration-200 hover:text-white">Gallery</Link></li>
              <li><Link href="/testimonials" className="transition duration-200 hover:text-white">Our Testimonials</Link></li>
              <li><Link href="/contact" className="transition duration-200 hover:text-white">Contact</Link></li>
              <li><Link href="/contact" className="transition duration-200 hover:text-white">Privacy Policy</Link></li>
              <li><Link href="/contact" className="transition duration-200 hover:text-white">Terms and Conditions</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              <li><Link href="/#services" className="transition duration-200 hover:text-white">Landscaping ▾</Link></li>
              <li><Link href="/#services" className="transition duration-200 hover:text-white">Hardscape ▾</Link></li>
              <li><Link href="/#services" className="transition duration-200 hover:text-white">Grading &amp; Drainage</Link></li>
              <li><Link href="/#services" className="transition duration-200 hover:text-white">Sod Installation</Link></li>
              <li><Link href="/#services" className="transition duration-200 hover:text-white">Ground Cover</Link></li>
              <li><Link href="/#services" className="transition duration-200 hover:text-white">Concrete ▾</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              <li>
                <a href="tel:+14706095370" className="flex items-center gap-2 transition duration-200 hover:text-white">
              ...
              <li>
                <a href="mailto:office@thelandscapingbrothers.com" className="flex items-center gap-2 transition duration-200 hover:text-white">
